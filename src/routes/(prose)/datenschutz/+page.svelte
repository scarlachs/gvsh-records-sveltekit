...
<p>
	Wir haben diese Datenschutzerklärung (Fassung 15.03.2024-312746961) verfasst, um Ihnen gemäß der
	Vorgaben der <a
		href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&from=DE&tid=312746961#d1e2269-1-1"
		target="_blank"
	...
	als Verantwortliche &ndash; und die von uns beauftragten Auftragsverarbeiter (z. B. Provider) &ndash;
...
<p>
	...
	technische <strong>Begriffe leserfreundlich erklärt</strong>, Links zu weiterführenden
	Informationen geboten und <strong>Grafiken</strong> zum Einsatz gebracht. Wir informieren damit
	in klarer und einfacher Sprache, dass wir im Rahmen unserer Geschäftstätigkeiten nur dann
	personenbezogene Daten verarbeiten, wenn eine entsprechende gesetzliche Grundlage gegeben ist.
	Das ist sicher nicht möglich, wenn man möglichst knappe, unklare und juristisch-technische
	Erklärungen abgibt, so wie sie im Internet oft Standard sind, wenn es um Datenschutz geht. Ich
	hoffe, Sie finden die folgenden Erläuterungen interessant und informativ und vielleicht ist die
...
<p>
	...
	<a
		...
		target="_blank"
		rel="noopener">https://eur-lex.europa.eu/legal-content/DE/ALL/?uri=celex%3A32016R0679</a
	> nachlesen.
</p>
...
<ol>
	...
	<li>
		...
		Daten vor. Wir müssen zum Beispiel gewisse Daten verarbeiten, um unsere Website sicher und wirtschaftlich
...
<p>
	...
	Sie nachfolgend die Kontaktdaten der verantwortlichen Person bzw. Stelle:<br />
	Pascal Schaar<br />
	Bornwiese 2, 21391 Reppenstedt, Deutschland
</p>
<p>
	{@html "E-Mail: in<!-- @wn -->fo<!-- .qmd- -->@sc<!-- $d;@ -->haa<!-- .com -->r.dev"}
</p>
<p>
	Impressum: <a href="https://schaar.dev/impressum/">https://schaar.dev/impressum/</a>
</p>
...
<p>
	<strong>Kurz gesagt:</strong> Sie haben Rechte &ndash; zögern Sie nicht, die oben gelistete verantwortliche
...
<p>
	...
	Website Sie unter <a href="https://www.dsb.gv.at/?tid=312746961" target="_blank" rel="noopener"
...
<h2 id="niedersachsen-datenschutzbehoerde">Niedersachsen Datenschutzbehörde</h2>
<p>
	...
	<strong>E-Mail-Adresse:</strong> poststelle@lfd.niedersachsen.de<br />
	<strong>Website: </strong>
	<a href="https://lfd.niedersachsen.de/startseite/?tid=312746961" target="_blank" rel="noopener"
		>https://lfd.niedersachsen.de/startseite/</a
	>
</p>
...
<p>
	...
	oder zur Erfüllung eines Vertragsverhältnisses notwendig und in jedem Fall nur soweit dies
	generell erlaubt ist. Ihre Zustimmung ist in den meisten Fällen der wichtigste Grund, dass wir
	Daten in Drittländern verarbeiten lassen. Die Verarbeitung personenbezogener Daten in
...
<p>
	...
	dann ein angemessenes Schutzniveau für den Datentransfer in die USA besteht, wenn ein
	US-Unternehmen, das personenbezogene Daten von EU-Bürgern in den USA verarbeitet, aktiver
	Teilnehmer des EU-US Data Privacy Frameworks ist. Mehr Informationen dazu finden Sie unter: <a
...
<p>
	...
	auf einzelne Daten nehmen. Zudem kann es vorkommen, dass erhobene Daten mit Daten aus anderen
	Diensten desselben Anbieters, sofern Sie ein entsprechendes Nutzerkonto haben, verknüpft werden.
	Nach Möglichkeit versuchen wir Serverstandorte innerhalb der EU zu nutzen, sofern das angeboten
	wird.<br />
	Wir informieren Sie an den passenden Stellen dieser Datenschutzerklärung genauer über Datenübertragung
	in Drittländer, sofern diese zutrifft.
</p>
...
<p>
	Art. 25 DSGVO spricht hier von &bdquo;Datenschutz durch Technikgestaltung und durch
	datenschutzfreundliche Voreinstellungen&rdquo; und meint damit, dass man sowohl bei Software (z.
	B. Formularen) also auch Hardware (z. B. Zugang zum Serverraum) immer an Sicherheit denkt und
...
<p>
	...
	Hypertext Transfer Protocol Secure steht für &bdquo;sicheres
	Hypertext-Übertragungsprotokoll&rdquo;), um Daten abhörsicher im Internet zu übertragen.<br />
	Das bedeutet, dass die komplette Übertragung aller Daten von Ihrem Browser zu unserem Webserver abgesichert
	ist &ndash; niemand kann &bdquo;mithören&rdquo;.
</p>
<p>
	Damit haben wir eine zusätzliche Sicherheitsschicht eingeführt und erfüllen den Datenschutz
	durch Technikgestaltung (<a
		href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&from=DE&tid=312746961"
		target="_blank"
	...
	Wenn Sie mehr zum Thema Verschlüsselung wissen möchten, empfehlen wir die Google Suche nach &bdquo;Hypertext
	Transfer Protocol Secure wiki&rdquo; um gute Links zu weiterführenden Informationen zu erhalten.
</p>
	...
	<tbody>
		<tr>
			<td>
				...
				Abs. 1 lit. b DSGVO (Vertrag), Art. 6 Abs. 1 lit. f DSGVO (Berechtigte Interessen)</td
			>
		</tr>
	</tbody>
</table>
...
<p>
	...
	warum dieser benötigt wird. Weil das Wort &bdquo;Auftragsverarbeitungsvertrag&rdquo; ein
...
<p>
	...
	Daten verarbeitet, gilt als Auftragsverarbeiter. Auftragsverarbeiter können folglich
	Dienstleister wie Hosting- oder Cloudanbieter, Bezahlungs- oder Newsletter-Anbieter oder große
...
<p>
	<strong>Betroffener</strong>(Sie als Kunde oder Interessent) → <strong>Verantwortlicher</strong>
	(wir als Unternehmen und Auftraggeber) → <strong>Auftragsverarbeiter</strong> (Dienstleister wie
...
<p>
	...
	einen AVV abgeschlossen. Darin wird allen voran festgehalten, dass der Auftragsverarbeiter die
	zu bearbeitenden Daten ausschließlich gemäß der DSGVO verarbeitet. Der Vertrag muss schriftlich
	abgeschlossen werden, allerdings gilt in diesem Zusammenhang auch der elektronische
	Vertragsabschluss als „schriftlich“. Erst auf der Grundlage des Vertrags erfolgt die
	Verarbeitung der personenbezogenen Daten. Im Vertrag muss folgendes enthalten sein:
</p>
<ul>
...
<p>
	Wie so eine AVV konkret aussieht, können Sie sich beispielsweise unter <a
		href="https://www.wko.at/service/wirtschaftsrecht-gewerberecht/eu-dsgvo-mustervertrag-auftragsverarbeitung.html"
		target="_blank"
		rel="noopener"
		>https://www.wko.at/service/wirtschaftsrecht-gewerberecht/eu-dsgvo-mustervertrag-auftragsverarbeitung.html</a
...
<p>
	Wenn Sie heutzutage Websites besuchen, werden gewisse Informationen &ndash; auch
	personenbezogene Daten &ndash; automatisch erstellt und gespeichert, so auch auf dieser Website.
	Diese Daten sollten möglichst sparsam und nur mit Begründung verarbeitet werden. Mit Website
	meinen wir übrigens die Gesamtheit aller Webseiten auf einer Domain, d.h. alles von der
	Startseite (Homepage) bis hin zur aller letzten Unterseite (wie dieser hier). Mit Domain meinen
	wir zum Beispiel beispiel.de oder musterbeispiel.com.
</p>
<p>
...
<ul>
	...
	<li>
		die Adresse (URL) der zuvor besuchten Seite (Referrer URL) (z. B. <a
			href="https://www.beispielquellsite.de/vondabinichgekommen/"
			target="_blank"
			rel="noopener">https://www.beispielquellsite.de/vondabinichgekommen/</a
		>)
	</li>
	<li>
	...
	<tbody>
		<tr>
			<td>
				...
				&#x2696;&#xfe0f; Rechtsgrundlagen: Art. 6 Abs. 1 lit. a DSGVO (Einwilligung), Art. 6
				Abs. 1 lit. f DSGVO (Berechtigte Interessen)</td
			>
		</tr>
	</tbody>
</table>
...
<p>
	Informationen zu speziellen Web-Analytics-Tools, erhalten Sie &ndash; sofern vorhanden &ndash;
	...
	<tbody>
		<tr>
			<td>
				...
				bei den jeweils eingesetzten Webdesign-Tools.<br />
...
<p>
	...
	Google erreichen Sie den Support unter <a
		href="https://support.google.com/?hl=de"
		target="_blank"
		rel="noopener">https://support.google.com/?hl=de</a
	>.
</p>
<h3>Rechtsgrundlage</h3>
<p>
...
<p>
	Informationen zu speziellen Webdesign-Tools erhalten Sie &ndash; sofern vorhanden &ndash; in den
...
<p>
	...
	verantwortlich. Wir haben die Google-Schriftarten lokal, d.h. auf unserem Webserver &ndash;
	nicht auf den Servern von Google &ndash; eingebunden. Dadurch gibt es keine Verbindung zu
...
<p>
	...
	Verzeichnis mit über 800 Schriftarten, die Google kostenlos bereitstellt. Mit Google Fonts
	könnte man Schriften nutzen, ohne sie auf den eigenen Server hochzuladen. Doch um diesbezüglich
	jede Informationsübertragung zu Google-Servern zu unterbinden, haben wir die Schriftarten auf
	unseren Server heruntergeladen. Auf diese Weise handeln wir datenschutzkonform und senden keine
	Daten an Google Fonts weiter.
</p>
...
<p>
	...
	als auf die leichte Schulter.<br />
	Uns ist es wichtig, Sie nach bestem Wissen und Gewissen über die Verarbeitung personenbezogener Daten
	zu informieren. Dabei wollen wir Ihnen aber nicht nur mitteilen, welche Daten verarbeitet werden,
	sondern auch die Beweggründe für die Verwendung diverser Softwareprogramme näherbringen. In der Regel
	klingen Datenschutzerklärung sehr technisch und juristisch. Da die meisten von Ihnen aber keine Webentwickler
	oder Juristen sind, wollten wir auch sprachlich einen anderen Weg gehen und den Sachverhalt in einfacher
	und klarer Sprache erklären. Immer ist dies natürlich aufgrund der Thematik nicht möglich. Daher
	werden die wichtigsten Begriffe am Ende der Datenschutzerklärung näher erläutert.<br />
	Bei Fragen zum Thema Datenschutz auf unserer Website zögern Sie bitte nicht, uns oder die verantwortliche
	Stelle zu kontaktieren. Wir wünschen Ihnen noch eine schöne Zeit und hoffen, Sie auf unserer Website
...
<p>
	Quelle: Erstellt mit dem <a
		...
		target="_blank"
		rel="noopener">Datenschutz Generator</a
	> von AdSimple
</p>
